...
export default function ChatInput() {
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-center flex-col lg:flex-row w-full max-w-xl space-y-8 lg:space-y-0 lg:space-x-6 mb-6">
        <button
        ...
        >
          <span className="flex px-4 py-2 text-sm text-left h-full flex items-center">
        ...
        >
          <span className="block px-2 py-2 text-sm text-left h-full flex items-center">
        ...
        <button
          ...
          className="relative p-2 rounded-lg w-full max-w-2xl mb-6 bg-transparent hover:bg-transparent transition duration-200 flex items-center justify-center"
        >
          <span className="block px-4 py-2 text-sm text-left h-full flex items-center">
